...
* [ArcGIS API for JavaScript resources - TypeScript and Bower](https://github.com/Esri/jsapi-resources)
* [Discover the Next-Generation ArcGIS API 4 for JavaScript](http://training.esri.com/gateway/index.cfm?fa=catalog.webCourseDetail&courseID=3059)
...
* [4.0 Beta Samples](https://github.com/odoe/esrijs4-demos)
* [View Models in 4.0beta](http://odoe.net/blog/view-models-in-arcgis-js-api/)
* [Bower](http://odoe.net/blog/using-bower-with-esrijs/)
 

# Blog resources
* [ArcGIS API for JavaScript blogs](http://blogs.esri.com/esri/arcgis/tag/arcgis-api-for-javascript/)
* [odoenet](http://odoe.net/blog/)
* [GeoDev Adventures](https://geonet.esri.com/people/odoe/blog)
